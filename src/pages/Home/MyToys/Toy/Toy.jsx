...
const Toy = ({ toy, index }) => {
  ...
  const handleUpdated = (id) => {
    try {
      fetch(
        `https://toy-shop-server-sifatullahshoyon-sifat-ullah-shoyons-projects.vercel.app/products/${id}`,
        {
          method: "PATCH",
          ...
          <div className="flex items-center justify-center">
            <Link to={`/updatedToy/${_id}`}>
              <button
                ...
                className="btn btn-circle my-btn mr-3"
              >
                <HiPencilSquare />
              </button>
            </Link>
            <button
              ...
              className="btn btn-circle my-btn"
            >
              <svg
