    ...
    <div className="py-32">
      ...
      <Marquee>
        <div className="flex flex-wrap gap-6 pt-5 mr-5">
          <div className="w-[180px] h-[140px] rounded-lg shadow-lg bg-transparent  p-5 bg-gradient-to-b from-[#37152C] to-transparent hover:border hover:border-white hover:transition-transform hover:delay-200">
