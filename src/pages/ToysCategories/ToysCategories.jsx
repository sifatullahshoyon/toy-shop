    ...
    <section className="py-32 px-10">
      ...
      <Marquee>
        <div className="flex flex-wrap gap-6 pt-5 mr-5">
          <div className="w-[180px] h-[140px] rounded-lg shadow-lg p-5 bg-gradient-to-b from-coustom to-transparent hover:border hover:border-white hover:transition-transform hover:delay-200">
